...
## Install bundle (ElasticSearch and Cesium+ Pod)  
 ...
 - Edit the configuration file `config/elasticsearch.yml`, in particular this properties:
    ...
    cluster.name: gchange-pod-g1-TEST
    ...
    cluster.remote.port: gchange-pod.domain.com
...
[2016-09-24 00:16:46,257][INFO ][plugins                  ] [ES-NODE-1] modules [reindex, lang-expression, lang-groovy], plugins [mapper-attachments, gchange-pod-g1-TEST], sites [gchange-pod-g1-TEST]
...
[2016-09-24 00:16:47,924][INFO ][discovery                ] [ES-NODE-1] gchange-pod-g1-TEST/jdzzh_jUTbuN26Enl-9whQ
