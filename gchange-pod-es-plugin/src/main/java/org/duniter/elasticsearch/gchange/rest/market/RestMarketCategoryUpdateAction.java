...
public class RestMarketCategoryUpdateAction extends AbstractRestPostUpdateAction {

    @Inject
    public RestMarketCategoryUpdateAction(Settings settings, RestController controller, Client client, RestSecurityController securityController,
                                          MarketService service) {
        super(settings, controller, client, securityController,
                MarketIndexRepository.INDEX, MarketIndexRepository.CATEGORY_TYPE,
                (id, json) -> service.updateCategoryFromJson(id, json));
    }
